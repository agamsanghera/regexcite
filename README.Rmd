...
**NOTE: This is a toy package created for assignment purposes, for the second edition of [R Packages](https://r-pkgs.org). It is not meant to actually be useful. If you want a package for factor handling, please see [stringr](https://stringr.tidyverse.org), [stringi](https://stringi.gagolewski.com/),
...
You can install the development version of regexcite from [GitHub](https://github.com/agamsanghera/regexcite) with:

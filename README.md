...
**NOTE: This is a toy package created for assignment purposes, for the
...
[GitHub](https://github.com/agamsanghera/regexcite) with:

``` r
# install.packages("devtools")
devtools::install_github("agamsanghera/regexcite")
```
